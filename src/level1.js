...
createPlatforms() {
  ...
  platforms.create(180, 400, 'tile2').setSize(100, 40).setScale(0.5);
  platforms.create(400, 330, 'tile2').setSize(100, 40).setScale(0.5);
  platforms.create(360, 160, 'tile3').setSize(100, 40).setScale(0.5);
...
createDoor() {
  ...
  doors.create(675, 450, 'door').setSize(50, 40).setScale(0.2);
