...
create() {
  ...
  this.anims.create({
    ...
    frames: this.anims.generateFrameNames('soha', {
      start: 1, end: 3, prefix: 'right-walk-', suffix: '.png',
    }),
    repeat: -1,
    frameRate: 5,
  });
  ...
  this.anims.create({
    key: 'soha-left',
    frames: this.anims.generateFrameNames('soha', {
      start: 1, end: 3, prefix: 'left-walk-', suffix: '.png',
    }),
    repeat: -1,
    frameRate: 5,
  });
...
createPlatforms() {
  ...
  platforms.create(200, 400, 'tile4').setSize(100, 40).setScale(0.5);
  platforms.create(300, 300, 'tile2').setSize(100, 40).setScale(0.5);
  platforms.create(400, 200, 'tile4').setSize(100, 40).setScale(0.5);
  platforms.create(100, 150, 'tile2').setSize(100, 40).setScale(0.5);
  platforms.create(700, 190, 'tile4').setSize(100, 40).setScale(0.5);
  platforms.create(280, 90, 'tile4').setSize(100, 40).setScale(0.5);
  platforms.create(650, 300, 'tile2').setSize(100, 40).setScale(0.5);
  platforms.create(530, 130, 'tiles').setSize(20, 40).setScale(0.5);
...
createDanger() {
  ...
  dangers.create(200, 375, 'spike').setSize(30, 10).setScale(0.3);
  dangers.create(300, 275, 'rock').setSize(30, 10).setScale(0.3);
  dangers.create(400, 175, 'plant').setSize(30, 10).setScale(0.3);
  dangers.create(315, 65, 'plant').setSize(30, 10).setScale(0.3);
  dangers.create(315, 450, 'mushroom').setSize(30, 10).setScale(0.3);
  dangers.create(350, 450, 'mushroom').setSize(30, 10).setScale(0.3);
...
createDoor() {
  ...
  doors.create(675, 260, 'door').setSize(50, 40).setScale(0.2);
